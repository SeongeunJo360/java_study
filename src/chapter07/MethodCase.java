...
public class MethodCase {
	...
	//리턴타입 X, 매개변수 O : 매개변수의 타입과 갯수에 따라 메소드 오버로딩(Overloading) 구형이 가능
	...
	public static void main(String[] args) {
		...
		mc.method1();
		System.out.println("--------------------------------\n");
		System.out.println("--리턴타입 O, 매개변수 X--");
		int sum = mc.method2();
		System.out.println("method2 --> " +sum);
		System.out.println("method2 --> " +sum);
		System.out.println("--------------------------------\n");
		System.out.println("--리턴타입 X, 매개변수 O--");
		mc.method3(10, 20);
		mc.method3("홍길동");
		System.out.println("--------------------------------\n");
		System.out.println("--리턴타입 O, 매개변수 O--");
