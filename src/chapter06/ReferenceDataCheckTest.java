...
public class ReferenceDataCheckTest {
	...
	public static void main(String[] args) {
		...
		int a = 10;
		int b = 10;
		String str1 = "홍길동 자바천재";
		String str2 = "홍길동 자바천재";
		String str3 = "이순신 자바천재";
		
		System.out.println(System.identityHashCode(str1));
		System.out.println(System.identityHashCode(str2));
		System.out.println(System.identityHashCode(str3));
		System.out.println(a+" == "+b);//call by value 형태로 값을 비교
		...
		System.out.println("strObj1 == strObj2 : " +(strObj1 == strObj2));//String type 이어서 false-> stack 주소비교
		System.out.println("strObj1.equals(strObj2) : " +(strObj1.equals(strObj2)));//주소는 다르지만 객체는 같다
